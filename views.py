	...
	if request.method=="POST":
		...
		if length==1:
			if "1" in arranged_values_json:
				step2.draw_for_floor_1(file_pool[0],arranged_values_json["1"])
				file_pool.append("public/2.png")
				file_pool.append("public/3.png")

			if "2" in arranged_values_json:
				var=file_pool[0]
				step2.draw_for_floor_2(var,arranged_values_json["2"])
				file_pool=[]
			...
			if "3" in arranged_values_json:
				var=file_pool[0]
				step2.draw_for_floor_3(var,arranged_values_json["3"])
				file_pool=[]
				file_pool.append("public/1.png")
				file_pool.append("public/2.png")
				file_pool.append(var)
		...
		if length==2:
			...
			if '2' in arranged_values_json and '3' in arranged_values_json:
				...
				var=file_pool[0]
				var1=file_pool[1]
				step2.draw_for_floor_2(file_pool[0],arranged_values_json["2"])

				step2.draw_for_floor_3(file_pool[1],arranged_values_json["3"])
		...
		if length==3:
			step2.draw_for_floor_1(file_pool[0],arranged_values_json["1"])
			step2.draw_for_floor_2(file_pool[1],arranged_values_json["2"])
			step2.draw_for_floor_3(file_pool[2],arranged_values_json["3"])
